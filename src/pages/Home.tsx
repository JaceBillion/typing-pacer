    ...
    >
      <div className="w-full max-w-4xl flex flex-col md:flex-row justify-between items-center gap-4 mb-8">
        <div className="flex flex-wrap justify-center gap-4">
          <div className="flex flex-wrap justify-center gap-2 bg-slate-ui p-1 rounded-full border border-white/5">
          ...
          <div className="flex justify-center gap-2 bg-slate-ui p-1 rounded-full border border-white/5">
            {[30, 60, 90].map((dur) => (
              <button
                key={dur}
        ...
        <div className="flex items-center gap-4 bg-slate-ui px-4 py-2 rounded-full border border-white/5 w-full md:w-auto justify-center">
